...
class JackCompiler:
    ...
    def compile_subroutine(self):
        self.jack_array.append('<subroutineDec>')  # <SubroutineDec>
        ...
        # ParameterList:
        self.advance()
        is_void = self.compile_parameter_list()
        ...
        # SubroutineBody -----------------------------------------------------------------------
        self.jack_array.append('<subroutineBody>')  # <subroutineBody>
        # {: <symbol> { </symbol>
        self.advance()
        self.jack_array.append(self.current_token)
        ...
        # Statements-- THE CONFUSING PART IF STATEMENT KA NA 5/19/2020
        self.advance()
    ...
    def compile_statements(self):
        self.jack_array.append('<statements>')  # <Statements>
    ...
    def compile_if_statement(self):
        self.jack_array.append('<ifStatement>')  # <Statements: ifStatement>
        ...
        self.jack_array.append('</ifStatement>')

        # end of ifStatement----------------------------------------------

    def compile_return_statement(self):
        self.jack_array.append('<returnStatement>')  # <Statements: returnStatement>
    ...
    def compile_do_statement(self):
        self.jack_array.append('<doStatement>')  # <Statements: doStatement>
        ...
        # Subroutine Call:
        self.advance()
        self.og_compile_subroutine_call()
    ...
    def compile_let_statement(self):
        self.jack_array.append('<letStatement>')  # <Statements: letStatement>
        ...
        self.jack_array.append('</letStatement>')  # <Statements>
        # end of Let Statement-----------------------------------

    def compile_expression(self):
        self.jack_array.append('<expression>')  # <Expression>
    ...
    def compile_term(self):
        self.jack_array.append('<term>')  # <term>
        ...
        self.jack_array.append('</term>')

        # END OF TERM----------------------------------

    def og_compile_subroutine_call(self):
        self.jack_array.append(self.current_token)
    ...
    def compile_expression_list(self):
        self.jack_array.append('<expressionList>')  # <expressionList>
    ...
    def compile_parameter_list(self):
        self.jack_array.append('<parameterList>')  # <parameterList>
        ...
        self.jack_array.append('</parameterList>')

        return is_void

    def compile_var_dec(self):
        self.jack_array.append('<varDec>')  # <varDec>
    ...
    def check_insert_comma(self, is_comma):
        if is_comma:
            self.advance()
            self.jack_array.append(self.current_token)
